...
for i in range(1,m):
    ...
    if dimini!=dimfin:
        t=1
if t==1:
    print('has ingresado estos {} vectores: \n'.format(m))
    b=[]
    for i in range(0,m):
    ...
    if dimini==2:
        print('Has ingresado estos {} vectores de dimension {}\n: '.format(m,dimini+1))
        b=[]
        for i in range(0,m):
            b.append(mivect(vectores[i]))
            print('{} \n'.format(tuple(b[i])))
